{
  ...
  inputs = {
    ...
    home-manager = {
      ...
      url = "github:nix-community/home-manager/99c9ec63390f1d8c14d95d9e8b17cc29cfbd4e11"; # master
      inputs.nixpkgs.follows = "nixpkgs";
    };
    ...
    nix-homebrew = {
      ...
      url = "github:zhaofengli/nix-homebrew/ec8417a617de4d3c739aed40837e308ebd667165"; # main
    ...
    homebrew-core = {
      ...
      url = "github:homebrew/homebrew-core/5ecb0984ecf31fea0caf5a0bc2f76784449791da"; # main
      flake = false;
    };
    homebrew-cask = {
    ...
    homebrew-barutsrb-tap = {
      ...
      url = "github:BarutSRB/homebrew-tap/4e22d60589fa0224c4c2b22daacaf0f021211d93"; # main
      flake = false;
    };

    # NixOS profiles to optimize settings for different hardware
    # renovate: datasource=git-refs depName=https://github.com/nixos/nixos-hardware
    hardware.url = "github:nixos/nixos-hardware/dc3f0cfde2050172abf6c3cdb684f735c15a57c5"; # master
    ...
    caelestia-shell = {
      ...
      url = "github:caelestia-dots/shell/24aa15eefdb146350d2548c0a015b04eddbd1008"; # v2.4.0
      inputs.nixpkgs.follows = "nixpkgs";
    ...
    claude-plugins-official = {
      ...
      url = "github:anthropics/claude-plugins-official/ed404106fcd80ba98ecb7c851e531dcb626d13b7"; # main
      flake = false;
    };
    superpowers = {
